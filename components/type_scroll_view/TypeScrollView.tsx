...
import * as StringUtility from '@/utils'
          ...
          isParentLayouted && typesArr.map((slideName, index) =>
            ...
            !types ? (
              <RectangleButton
                ...
                key={slideName}
                style={{...Styles.spacings.me_12, width: 70}}
              >
                <FC.AppText font="body1"> </FC.AppText>
              </RectangleButton>
            ) :
            (
              <View
                  ...
                  ? (
                    ...
                    >
                      ...
                      {(isActive, currentLabelStyle) => (
                        <FC.AppText style={currentLabelStyle} font="body1">{labelsArrInTitleCase[index]}</FC.AppText>
                      )}
                    </RectangleButton>
                  )
                  : (
                    ...
                    {/* TODO: fix */}
                      ...
                      >
                        {/* TODO: fix */}
                        {(isActive, currentLabelStyle) => (
                          <FC.AppText style={currentLabelStyle} weight="lighter" font="h5">{typesArrInTitleCase[index]}</FC.AppText>
                        )}
                      </RectangleButton>
                      <Animated.View
                        key={slideName + 'line'}

 ...
 */
export const setItemsStorage = async (data: Map<string, string>): Promise<boolean> => {
  try {
    const promises = [];
 ...
 */
export const setItemStorage = async (data: Map<string, string>): Promise<boolean> => {
  try {
 ...
 */
export const getItemsStorage = async (keys: string[]): Promise<Map<string, string>> => {
